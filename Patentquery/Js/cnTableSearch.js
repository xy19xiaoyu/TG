...
function getTableSearchQuery() {
    ...
    $("[id^='Txb']").each(function () {
        var obj = $(this);

        var strValue = $(this).attr("value").Trim();
        var strKey = $(this).attr("lang").toUpperCase(); 
...
// var res = "F XX (200302/AD + 200201/AD) * (计算机/TI)";
// var res = "F XX ( (200302/AD + 200201/AD) * (计算机/TI)) + (200501/AD)";
var m_Entrances = "AN,PN,IC,PR,IN,PA,AG,TI,CL,AD,PD,CT,CO,DZ,TX,AB,DS,CS,GN,GD,AE,IE,PE,TE,MC,AT,ST,PO,CC,"; //所有入口,以，连接多个
