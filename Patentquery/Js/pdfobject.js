...
var PDFObject = function (y) {
    ...
    var o = function (d) {
        ...
        switch (d) {
            ...
            case "height": c = z;
                break;
            case "pdfOpenParams": c = r;
                break;
            case "pluginTypeFound": c = x;
                break;
            case "pdfobjectversion": c = w;
                break;
        }
        return c;
    };
    var n = function (d) {
        ...
        //        c.innerHTML = "<object classid='clsid:CA8A9780-280D-11CF-A24D-444553540000' width='" + i + "' height='" + z + "' border='0'>";
        //        c.innerHTML += "<param name='_Version' value='65539' />";
        //        c.innerHTML += "<param name='_ExtentX' value='20108' />"
        //        c.innerHTML += "<param name='_ExtentY' value='10866' />";
        //        c.innerHTML += "<param name='_StockProps' value='0' />";
        //        c.innerHTML += "<param name='SRC' value='" + a + "' />";
        //c.innerHTML += '<object	data="' + a + '" type="application/pdf" width="' + i + '" height="' + z + '">';
        //c.innerHTML += "alt : <a href='" + a + "'>test open pdf</a></object>";
        //c.innerHTML += "</object>";
