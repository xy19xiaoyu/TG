...
namespace Cpic.Cprs2010.Cfg.Confusion
{
    ...
    public class Common
    {
        ...
        public static readonly String DocDB_File_Root = @" E:\\DOCDB_Service\\DOCDB_DATASOURCE_DIR\\";//docdb文献根路径
        public static readonly String DocDB_DTDPath = String.Empty;// @"\\10.75.8.118\\DOCDB_Service\\DOCDB_DTD\\docdb-entities.dtd";
        public static readonly String DocDB_Index_Root = @"E://DOCDB_Process//USData//";//DocDB索引信息根目录
        ...
        public static readonly String DWPI_OtherBiblographicIndex_File_cfg //其他著录项目文件说明
                                    ...
                                    + "</keys>";
        //中文
        public static readonly String CN_Abstract_Root = @"\\10.1.11.36\\userdir\\xml\\";//存放中文摘要文献的根目录
