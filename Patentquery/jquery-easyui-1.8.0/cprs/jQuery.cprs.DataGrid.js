...
jQuery.fn.extend({
    ...
    DataGrid:function(width,height,dt){
        this.each(function(){
            var TableBody=$(this);
            var MyTableId="cprs-table-"+TableBody.attr('id');
            if($(this).data('Drawed')){
            ...
            TableBody.wrap("<div id='"+MyTableId+"' class='cprs-table'></div>");
            ...
            //添加排序-----------------------
                ...
                if(td.attr('sort')=='true'){
                    ...
                    hc.toggle(function(){
                                   ...
                                   sortTable(TableBody, tdindex, tddatatype, null, 1); 
