<%@ Page Title="" Language="C#" MasterPageFile="~/Master/index.Master" AutoEventWireup="true"
    CodeBehind="frmCountryCode.aspx.cs" Inherits="Patentquery.My.frmCountryCode" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="left_content2" style="padding: 0px; width: 220px">
                ...
                <div class="panel" style="width: 220px; background-color: #FBEC88">
                    <div class="panel-header accordion-header accordion-header-selected" style="height: 16px;
                        width: 210px; border-width: 0 0 1px;">
                        <div class="panel-title">
                            <a href="#"><span style="color: #800000;">国别代码查询</span></a>
                        </div>
                    </div>
                </div>
    ...
    <div id="right" style="width: 768px; min-height: 550px;">
        <div id="right_top" class="right_top">
            请输入查询内容：<asp:TextBox ID="TextBox1" runat="server" Height="22px" Width="300px"></asp:TextBox>
        ...
        <div id="ipc_right_content" style="display:">
            <asp:GridView ID="grvRsData" runat="server" ForeColor="#1B2761" Width="100%" AutoGenerateColumns="false"
                ...
                <Columns>
                    <asp:BoundField HeaderText="国家/地区/组织代码" DataField="CCode">
                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="True" />
                    </asp:BoundField>
                    <asp:BoundField DataField="CName" HeaderText="国家/地区/组织名称" />
                </Columns>
